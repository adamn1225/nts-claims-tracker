...
export default function PortfolioGallery({
  ...
  // broker_portfolio is created by the broker-profiles migration and may not
  ...
  async function handleUpload() {
    ...
    try {
      ...
      const path = `${brokerId}/${Date.now()}_${safeName}`;
        ...
        <div className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-200 py-12 text-center">
          ...
          <p className="text-xs text-gray-400">
            {isOwn
              ...
              : "This broker hasn't added any photos yet."}
          </p>
        </div>
      ) : (
