...
export default function FloatingAiCoachButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-40 flex h-14 items-center gap-2 rounded-full bg-[#28323d] px-5 shadow-lg transition-all duration-200 hover:bg-[#1f2937] hover:shadow-xl active:scale-95 sm:h-16 sm:px-6"
    ...
    >
      <div className="relative">
        ...
        <Sparkles className="absolute -right-1 -top-1 h-3 w-3 text-orange-400 sm:h-3.5 sm:w-3.5" />
      </div>
      <span
